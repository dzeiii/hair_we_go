...
if source_option == "Use Live Camera":
    # 1. Custom CSS Inject to restrict webcam frame to a crisp, centered 4:3 style aspect box
    st.markdown(
        """
        <style>
        /* Target the native Streamlit camera viewport wrapper */
        div[data-testid="stCameraInput"] {
            max-width: 480px !important;  /* Controls the width on desktop layouts */
            margin: 0 auto !important;     /* Centers the container frame on screen */
            aspect-ratio: 4 / 3 !important; /* Forces the box layout container grid ratio */
        }
        /* Tighten internal camera component margins */
        div[data-testid="stCameraInput"] video {
            object-fit: cover !important; /* Crops the widescreen canvas preview to fill the box */
        }
        </style>
        """,
    ...
    # 2. Render the actual camera feed component inside our styled container limits
